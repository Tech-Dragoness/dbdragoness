            ...
            <div style={{ position: "relative" }}>
              ...
              {showAutocompleteSuggestions &&
                autocompleteSuggestions.length > 0 && (
                  <div
                    // IMPORTANT: onMouseDown prevents blur event from firing before click
                    onMouseDown={(e) => {
                  ...
                  >
                    {autocompleteSuggestions.map((suggestion, idx) => (
                      <div
                        key={idx}
                        // Use onClick - it will work now because onMouseDown prevents blur
                        onClick={() => {
